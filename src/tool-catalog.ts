...
const implemented = new Set([
  ...
  "lead_form_copy", "survey_form_copy", "lead_forms_archive_manage", "survey_forms_archive_manage", "lead_form_image_upload", "offer_batch_task_create",
  ...
  "vk_get_community_stats", "vk_get_vk_groups",
  "vk_get_video_report",
  ...
  "vk_get_remarketing_counter", "vk_update_remarketing_counter", "vk_delete_remarketing_counter",
  "vk_get_counter_goals", "vk_update_counter_goal",
  ...
  "vk_select_client",
  "vk_create_remarketing_list", "vk_update_remarketing_list", "vk_delete_remarketing_list",
  "vk_connect_client",
  "vk_manage_local_geo",
  "banner_preflight",
  "ad_plan_preflight",
...
const definitions: Array<[string, string, string, ToolAccess]> = [
  ...
  ["vk_get_statistics", "Статистика", "Статистика", "read"], ["vk_get_goal_statistics", "Статистика целей", "Статистика", "read"], ["vk_get_community_stats", "Статистика сообществ", "Статистика", "read"], ["vk_get_video_report", "Видеоотчёт", "Статистика", "read"], ["vk_get_inapp_stats", "In-app статистика", "Статистика", "read"], ["vk_get_offline_conversions", "Офлайн-конверсии", "Статистика", "read"], ["vk_get_realtime_stats", "Realtime статистика", "Статистика", "read"],
  ...
  ["vk_get_lead_forms", "Лид-формы", "Лиды", "read"], ["vk_get_leads", "Лиды", "Лиды", "read"], ["vk_update_lead_form", "Переименовать test-лид-форму", "Лиды", "write"], ["vk_export_leads", "Экспорт лидов", "Лиды", "write"], ["survey_respondents_export", "Экспорт ответов опроса", "Лиды", "write"], ["lead_form_test_lead_send", "Отправить test-лид", "Лиды", "write"], ["vk_get_async_report", "Асинхронный отчёт", "Отчёты", "read"], ["vk_create_async_report", "Создать отчёт", "Отчёты", "write"], ["vk_export_csv", "Экспорт CSV", "Отчёты", "read"], ["vk_export_xlsx", "Экспорт XLSX", "Отчёты", "read"], ["banner_preflight", "Проверить объявление до создания", "Объявления", "read"], ["ad_plan_preflight", "Проверить кампанию до создания", "Кампании", "read"], ["ad_group_preflight", "Проверить группу до создания", "Группы", "read"], ["vk_update_feed", "Изменить фид", "Контент", "write"],
