...
export type WriteOperation = Exclude<TestWriteOperation, "update_test_pricelist"> | "activate_configured_sharing_key" | "update_user_profile" | "delete_test_campaign" | "add_approved_communities_to_segment";
