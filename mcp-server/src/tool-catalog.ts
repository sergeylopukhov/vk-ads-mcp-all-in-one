...
const implemented = new Set([
  ...
  "vk_start_community_research", "vk_research_communities", "vk_get_community_research_progress", "vk_get_community_research_run", "vk_rescore_community_research_run", "vk_find_community_candidates", "vk_discover_communities", "vk_analyze_communities", "vk_score_communities", "vk_export_community_candidates",
]);
...
const definitions: Array<[string, string, string, ToolAccess]> = [
  ...
  ["vk_start_community_research", "Запустить исследование сообществ", "Сообщества VK", "read"], ["vk_research_communities", "Запустить исследование сообществ", "Сообщества VK", "read"], ["vk_get_community_research_progress", "Прогресс исследования сообществ", "Сообщества VK", "read"], ["vk_get_community_research_run", "Снимок исследования сообществ", "Сообщества VK", "read"], ["vk_rescore_community_research_run", "Пересчитать сохранённое исследование", "Сообщества VK", "read"], ["vk_find_community_candidates", "Найти и оценить сообщества", "Сообщества VK", "read"], ["vk_discover_communities", "Найти публичные сообщества", "Сообщества VK", "read"], ["vk_analyze_communities", "Анализ публичных сообществ", "Сообщества VK", "read"], ["vk_score_communities", "Скоринг сообществ", "Сообщества VK", "read"], ["vk_export_community_candidates", "Экспорт кандидатов сообществ", "Сообщества VK", "read"],
