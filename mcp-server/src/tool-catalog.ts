...
const implemented = new Set([
  ...
  "vk_find_community_candidates", "vk_discover_communities", "vk_analyze_communities", "vk_score_communities", "vk_export_community_candidates",
]);
...
const definitions: Array<[string, string, string, ToolAccess]> = [
  ...
  ["vk_find_community_candidates", "Найти и оценить сообщества", "Сообщества VK", "read"], ["vk_discover_communities", "Найти публичные сообщества", "Сообщества VK", "read"], ["vk_analyze_communities", "Анализ публичных сообществ", "Сообщества VK", "read"], ["vk_score_communities", "Скоринг сообществ", "Сообщества VK", "read"], ["vk_export_community_candidates", "Экспорт кандидатов сообществ", "Сообщества VK", "read"],
