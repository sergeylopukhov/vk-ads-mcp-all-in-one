...
const implemented = new Set([
  ...
  "vk_discover_communities", "vk_analyze_communities", "vk_score_communities", "vk_export_community_candidates", "vk_add_approved_communities_to_segment",
]);
...
const definitions: Array<[string, string, string, ToolAccess]> = [
  ...
  ["vk_discover_communities", "Найти публичные сообщества", "Сообщества VK", "read"], ["vk_analyze_communities", "Анализ публичных сообществ", "Сообщества VK", "read"], ["vk_score_communities", "Скоринг сообществ", "Сообщества VK", "read"], ["vk_export_community_candidates", "Экспорт кандидатов сообществ", "Сообщества VK", "read"], ["vk_add_approved_communities_to_segment", "Добавить утверждённые сообщества в сегмент", "Сообщества VK", "write"],
