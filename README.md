...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.2.0-6b7280" alt="Версия 0.2.0">
</p>
...
В текущей версии зарегистрировано 127 инструментов. Полный успешный live-тест прошли 103 инструмента; ещё 24 честно отмечены как непроверенные или неработающие. Все 10 инструментов сообществ пока имеют статус `⛔️`: их live-проверка намеренно отложена.
