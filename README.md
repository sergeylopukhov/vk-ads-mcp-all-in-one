...
В текущей версии зарегистрировано 128 инструментов. Из них 107 прошли проверку реальными вызовами, ещё 21 пока недоступен или не проверен. Для работы с сообществами VK доступны пять синхронных инструментов; пять фоновых инструментов пока имеют статус `⛔️`.
