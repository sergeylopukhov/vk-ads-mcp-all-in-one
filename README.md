...
> [!TIP]
> Установка выполняется одной командой. Установщик скачает сервер, запросит данные VK Ads и подключит выбранные MCP-клиенты. Если выбран Codex, он также установит навык для работы с VK Рекламой.
...
<table width="100%">
  ...
  <tbody>
    <tr>
      <td>Обновить</td>
      <td>Сервер и выбранный навык Codex будут обновлены. <code>auth.env</code>, токены и локальный аудит сохранятся</td>
    </tr>
    <tr>
