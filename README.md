...
Рабочий порядок: найдите сообщества, при необходимости проанализируйте их по ID, задайте собственные правила скоринга и экспортируйте кандидатов. Экспорт не создаёт аудитории и не добавляет сообщества в сегменты.
