...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.1.34-2563eb" alt="Версия 0.1.34">
</p>
...
Сервер работает с официальным VK Ads API: читает кампании, группы и объявления, получает статистику, управляет аудиториями, креативами, лид-формами, опросами, подписками, прайс-листами и справочниками. Отдельный блок Core VK API ищет и анализирует публичные сообщества. Поиск объединяет выдачу по релевантности и числу участников, сначала оценивает метаданные, затем анализирует публикации наиболее перспективных кандидатов. Предметные понятия, контекстные сочетания и отрицательные классы задаются в запросе, поэтому механизм подходит для разных отраслей.
