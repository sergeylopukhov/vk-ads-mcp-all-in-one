...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-1.2.3-6b7280" alt="Версия 1.2.3">
</p>
...
- `vk_research_communities`: основной инструмент. Принимает поисковые фразы и фильтры, автоматически анализирует активность, сохраняет снимок по `run_id` и отправляет уведомление о ходе раз в минуту, а затем итоговое уведомление. Универсальные правила учитывают совпадения, свежесть, долю тематических публикаций и штрафуют частоту ниже одной публикации в неделю; `scoring_rules` и `clusters` позволяют задать собственную модель.
