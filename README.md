...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.1.30-2563eb" alt="Версия 0.1.30">
</p>
...
Сервер работает с официальным VK Ads API: читает кампании, группы и объявления, получает статистику, управляет аудиториями, креативами, лид-формами, опросами, подписками, прайс-листами и справочниками. Отдельный блок Core VK API ищет и анализирует публичные сообщества. Поиск объединяет выдачу по релевантности и числу участников, учитывает русские словоформы, намерение аудитории, активность за 30 и 90 дней и долю нежелательного контента.
