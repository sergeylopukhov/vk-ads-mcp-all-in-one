...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.1.1-6b7280" alt="Версия 0.1.1">
</p>

Сервер подключает MCP-клиент к VK Рекламе: читает кампании, группы и объявления, получает статистику, работает с аудиториями, креативами, лид-формами, опросами, подписками, прайс-листами и справочниками.

В текущей версии зарегистрировано 117 инструментов. Полный успешный live-тест прошли 103 инструмента; ещё 14 честно отмечены как непроверенные или неработающие.
...
5. сохранит их в локальном `auth.env`;
6. подключит сервер к Codex под именем `vk-ads`;
7. установит навык Codex для безопасной работы с текущими tools.
