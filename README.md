...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-1.2.2-6b7280" alt="Версия 1.2.2">
</p>
...
- `vk_research_communities`: основной инструмент. Принимает поисковые фразы и фильтры, автоматически анализирует активность, возвращает прошедших и не прошедших порог кандидатов и сохраняет снимок по `run_id`. Универсальные правила учитывают совпадения, свежесть, долю тематических публикаций и штрафуют частоту ниже одной публикации в неделю; `scoring_rules` и `clusters` позволяют задать собственную модель.
