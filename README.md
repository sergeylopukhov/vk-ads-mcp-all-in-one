...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.1.346-2563eb" alt="Версия 0.1.346">
</p>
...
В текущей версии зарегистрирован 131 инструмент. Из них 117 прошли проверку реальными вызовами, ещё 14 пока недоступны или не проверены. Все 10 инструментов исследования сообществ VK и два инструмента источников сообществ для рекламных аудиторий доступны для обычной работы.
