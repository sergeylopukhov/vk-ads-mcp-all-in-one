...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.1.347-2563eb" alt="Версия 0.1.347">
</p>
...
В текущей версии зарегистрировано 132 инструмента. Из них 118 прошли проверку реальными вызовами, ещё 14 пока недоступны или не проверены. Все 10 инструментов исследования сообществ VK и три инструмента для аудиторий подписчиков доступны для обычной работы.
