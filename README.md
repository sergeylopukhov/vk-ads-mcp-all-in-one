...
| Реклама | Чтение структуры `ad_plans → ad_groups → banners`; запись выполняется после preflight и явного подтверждения, а отдельные операции ограничены тестовыми объектами. |
