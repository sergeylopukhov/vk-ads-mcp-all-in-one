...
Установщик запросит данные приложения, режим `readonly/write` и отдельно предложит включить поиск публичных сообществ VK. При включении Core VK API token вводится скрыто; при обновлении старой установки выбор появится снова. Затем установщик напечатает каталог установки. Codex подключится автоматически.
