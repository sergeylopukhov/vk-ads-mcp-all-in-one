...
Для обновления снова выполните команду для своей системы. Установщик покажет установленную и доступную версии. Выберите «обновить», чтобы сохранить настройки без дополнительных вопросов, или «установить заново», чтобы ввести все данные заново.
